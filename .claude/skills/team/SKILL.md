---
name: team
description: Launch a coordinated multi-agent workflow with intensity-based routing. Use when the user says "use the team", "coordinate agents", "multi-agent", "team workflow", or wants parallel agent execution on a complex task.
version: 1.0.0
user-invocable: true
---
