---
name: session-end
description: End-of-session wrap-up — write session logs, update memory, verify git status, and report summary. Use when the user says "end session", "wrap up", "I'm done for now", or "session end".
version: 1.0.0
user-invocable: true
---
