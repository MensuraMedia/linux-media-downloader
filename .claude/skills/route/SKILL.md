---
name: route
description: Score a task's intensity (1-10) and recommend the right agent and model tier (Haiku/Sonnet/Opus). Use when the user says "route this", "which agent", "what model should I use", or before delegating to a sub-agent.
version: 1.0.0
user-invocable: true
---
