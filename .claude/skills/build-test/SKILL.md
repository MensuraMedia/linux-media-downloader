---
name: build-test
description: Run the project's full build, lint, and test pipeline as defined in CLAUDE.md. Use when the user says "run tests", "build and test", "run the pipeline", "check if it builds", or "run CI locally".
version: 1.0.0
user-invocable: true
---
