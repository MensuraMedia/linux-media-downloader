...
# Chrome Extension Specialist (Sonnet) — Linux Media Downloader
...
- **Project**: Linux Media Downloader
- **Path**: /home/user/projects/linux-media-downloader
- **Description**: Flask + PyWebView + yt-dlp desktop media downloader
- **Date**: 2026-07-31
